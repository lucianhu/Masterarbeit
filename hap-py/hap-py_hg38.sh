#!/bin/bash
# Complex variant comparison in the human genome reference HG38
...
REFERENCE='/mnt/sda/Masterarbeit/Homo_sapiens/GATK/GRCh38/Sequence/WholeGenomeFasta/hg38.fa'

INTERVAL='/mnt/sda/Masterarbeit/Homo_sapiens/GATK/GRCh38/Annotation/intervals/sorted_hg38-exome-interval.bed'

VCFEVAL_PATH="$HOME/miniconda3/envs/hap.py/share/rtg-tools-3.12.1-0/rtg"

VCFEVAL_TEMPLATE='/mnt/sda/Masterarbeit/Homo_sapiens/GATK/GRCh38/Sequence/WholeGenomeFasta/hg38_SDF'
