...
vcf_folder <- "/home/lucianhu/Pangenome/tumors/SRR7890850/VCFs"
...
write.csv(heterozygous_filtered_POS, "/home/lucianhu/Pangenome/tumors/SRR7890850/VCFs/SRR7890850.heterozygous_counts_table.csv")
```
...
ggplot(data_long, aes(x = Fraction_Reference_allele_reads, y = `Read_depths`, fill = Samples)) +
  ...
  labs(
    ...
    subtitle = "Analysis of Heterozygous Alleles in WES of DEE Using DeepVariant"
  ) +
...
ggplot(data_long, aes(x = Alleles, y = Number_of_Reads, fill = Samples)) + 
  ...
  labs(
    ...
    x = "Alleles",
    y = "Number of Reads",
    subtitle = "Analysis of Homozygous Alleles in WES of DEE Using DeepVariant"
  ) +
